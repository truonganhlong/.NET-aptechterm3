...
namespace OMR_Service.Migrations
{
    ...
    [Migration("20230509173240_UpdateDays")]
    partial class UpdateDays
    {
            ...
            modelBuilder.Entity("OMR_Service.Models.Customer", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2023, 5, 10, 0, 32, 40, 252, DateTimeKind.Local).AddTicks(7029));
            ...
            modelBuilder.Entity("OMR_Service.Models.Employee", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 0, 32, 40, 224, DateTimeKind.Local).AddTicks(4449));
            ...
            modelBuilder.Entity("OMR_Service.Models.Feedback", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 0, 32, 40, 234, DateTimeKind.Local).AddTicks(4622));
            ...
            modelBuilder.Entity("OMR_Service.Models.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("Time")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 0, 32, 40, 238, DateTimeKind.Local).AddTicks(5848));
            ...
            modelBuilder.Entity("OMR_Service.Models.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransferTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 0, 32, 40, 248, DateTimeKind.Local).AddTicks(4367));
