...
namespace OMR_Service.Migrations
{
    ...
    [Migration("20230512190053_updatedatabseuser")]
    partial class updatedatabseuser
    {
            ...
            modelBuilder.Entity("OMR_Service.Models.Customer", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2023, 5, 13, 2, 0, 52, 805, DateTimeKind.Local).AddTicks(5533));
            ...
            modelBuilder.Entity("OMR_Service.Models.Employee", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 13, 2, 0, 52, 782, DateTimeKind.Local).AddTicks(7529));
            ...
            modelBuilder.Entity("OMR_Service.Models.Feedback", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 13, 2, 0, 52, 793, DateTimeKind.Local).AddTicks(4093));
            ...
            modelBuilder.Entity("OMR_Service.Models.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("Time")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 13, 2, 0, 52, 796, DateTimeKind.Local).AddTicks(4274));
            ...
            modelBuilder.Entity("OMR_Service.Models.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransferTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 13, 2, 0, 52, 802, DateTimeKind.Local).AddTicks(5525));
