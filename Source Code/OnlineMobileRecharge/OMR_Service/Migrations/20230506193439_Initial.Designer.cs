...
namespace OMR_Service.Migrations
{
    ...
    [Migration("20230506193439_Initial")]
            ...
            modelBuilder.Entity("OMR_Service.Models.Customer", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2023, 5, 7, 2, 34, 39, 30, DateTimeKind.Local).AddTicks(3489));
            ...
            modelBuilder.Entity("OMR_Service.Models.Employee", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 7, 2, 34, 39, 10, DateTimeKind.Local).AddTicks(2090));
            ...
            modelBuilder.Entity("OMR_Service.Models.Feedback", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 7, 2, 34, 39, 19, DateTimeKind.Local).AddTicks(3536));
            ...
            modelBuilder.Entity("OMR_Service.Models.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("Time")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 7, 2, 34, 39, 21, DateTimeKind.Local).AddTicks(3554));
            ...
            modelBuilder.Entity("OMR_Service.Models.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransferTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 7, 2, 34, 39, 27, DateTimeKind.Local).AddTicks(3483));
